 ...
 *
 */
public class ProductPieChart extends JPanel {
     ...
     */
    public ProductPieChart(final String title) {
    ...
    private PieDataset createSampleDataset() {
        ...
        for (int i = 0; i < elist.size(); i++) {
			...
			bean = elist.get(i);			
			result.setValue(bean.getName(), new Integer(bean.getQuantity()));
        } 
