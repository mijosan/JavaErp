...
public class Sell_Panel extends JPanel {
			...
			new DefaultMutableTreeNode("ERP_F") {
				{
					...
					node_1 = new DefaultMutableTreeNode("영업/구매 관리");
						node_1.add(new DefaultMutableTreeNode("판매등록"));
						node_1.add(new DefaultMutableTreeNode("판매조회"));					
						node_1.add(new DefaultMutableTreeNode("거래처등록"));									
					add(node_1);
				}
			}
		));
